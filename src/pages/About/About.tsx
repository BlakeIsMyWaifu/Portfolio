...
const About: FC = () => {
	...
	const paragraph = [
		...
		'Ever since I was little I\'ve had an interest in programming and technology. Over the last six years I\'ve managed to turn that interest into a hobby and passion. Now I\'m looking to take it to the next step and turn it into a career.',
